...
class _TraktLists():
    ...
    @is_authorized
    def get_mixed_list(self, path, trakt_types=[], limit=75, extended=None, authorize=False):
    ...
    @is_authorized
    def get_basic_list(self, path, trakt_type, page=1, limit=75, params=None, sort_by=None, sort_how=None, extended=None, authorize=False, randomise=False, always_refresh=True):
    ...
    @is_authorized
    def get_stacked_list(self, path, trakt_type, page=1, limit=75, params=None, sort_by=None, sort_how=None, extended=None, authorize=False, always_refresh=True, **kwargs):
    ...
    def get_custom_list(self, list_slug, user_slug=None, page=1, limit=75, params=None, authorize=False, sort_by=None, sort_how=None, extended=None, owner=False, always_refresh=True):
...
class TraktAPI(RequestAPI, _TraktSync, _TraktLists, _TraktProgress):
    def __init__(self, force=False, delay_write=False):
        ...
        self.sync = {}
        self.item_limit = 83 if ADDON.getSettingBool('trakt_expandedlimit') else 75  # 84 (83+NextPage) has common factors 4,6,7,8 suitable for wall views
